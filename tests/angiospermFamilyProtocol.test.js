...
import { familiasAngiospermasBrasilV1 } from "../src/protocols/botanica/familiasAngiospermasBrasilV1.js";
import {
  representativeCases,
  ambiguousCases,
  mixedCases,
} from "./fixtures/angiospermFamilyCases.js";
import { runProtocolCase } from "./helpers/runProtocolCase.js";

test(
  "protocolo de familias de angiospermas classifica casos representativos",
  () => {
...
test(
  "protocolo de familias de angiospermas mantem casos ambiguos em aberto",
  () => {
...
test(
  "protocolo de familias de angiospermas trata casos mistos com prudencia",
  () => {
    mixedCases.forEach(
      ({
        id,
