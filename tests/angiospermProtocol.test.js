...
import { grandesGruposAngiospermasV1 } from "../src/protocols/botanica/grandesGruposAngiospermasV1.js";
import {
  representativeCases,
  ambiguousCases,
  mixedCases,
} from "./fixtures/angiospermCases.js";
import { runProtocolCase } from "./helpers/runProtocolCase.js";

test(
  "protocolo de angiospermas classifica casos representativos",
  () => {
...
test(
  "protocolo de angiospermas mantem casos ambiguos em aberto",
  () => {
...
test(
  "protocolo de angiospermas trata casos mistos com prudencia",
  () => {
    mixedCases.forEach(
      ({
        id,
